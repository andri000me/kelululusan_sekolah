...
?>
<div class="container">
<h2>Manajemen Pengguna</h2><hr>
<div class="alert alert-warning"><strong>Peringatan !</strong><br>Hak akses user ini hanya digunakan orang tertentu saja, siapapun user yang memiliki hak akses ini dapat melakukan perubahan dalam database. Meskipun aplikasi ini telah dilengkapi enkripsi untuk password, <strong>jangan</strong> menggunakan kata-kata yang umum sebagai password admin atau defaultnya.</div>
<?php
