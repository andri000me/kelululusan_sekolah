...
<head>
    ...
    <meta name="description" content="Website Kelulusan Tahun 2020">
    <meta name="author" content="BORNEOLAB">
    
    <title>Pengumuman Kelulusan 2020 </title>
    ...
    <nav class="navbar navbar-default bg-success navbar-static-top">
        <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="./">Info Update Siswa Kelulusan <?=$hsl['sekolah'] ?></a>
            </div>
            <div id="navbar" class="collapse navbar-collapse">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="data.php">Data Siswa</a></li>
					<li><a href="konfigurasi.php">Setting</a></li>
					<li class="dropdown">
